    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            ...
            <div class="card-body py-3">
                <form action="{{ url("/invoice_update/$invoice->id") }}" method="POST" enctype="multipart/form-data"
                    autocomplete="off">
                    @csrf
                    {{-- 1 --}}
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input value="{{ $invoice->invoice_number }}" type="text" class="form-control" id="inputName" name="invoice_number"
                                title="Please Insert Invoice Number" required>
                        </div>

                        <div class="col">
                            <label>Invoice Date</label>
                            <input  value="{{ $invoice->invoice_Date }}" class="form-control fc-datepicker" name="invoice_Date" placeholder="YYYY-MM-DD"
                                type="date" value="{{ date('Y-m-d') }}" required>
                        </div>

                        <div class="col">
                            <label>Due Date</label>
                            <input value="{{ $invoice->Due_date }}" class="form-control fc-datepicker" name="Due_date" placeholder="YYYY-MM-DD"
                                type="date" required>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="number" value="{{ $invoice->Discount }}" class="form-control form-control-lg" id="Discount" name="Discount"
