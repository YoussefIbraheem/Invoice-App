            ...
            <div class="card card-invoice">
                <div class="card-body">
                    <div class="invoice-header">
                        <h1 class="invoice-title">Allocation Invoice</h1>
                    ...
                    <div class="row mg-t-20">
                        ...
                        <div class="col-md">
                            ...
                            <p class="invoice-info-row"><span>Creation Date</span>
                        ...
                        <table class="table table-invoice border text-md-nowrap mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="tx-center">Allocation Amount</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="tx-right">VAT Rate({{ $invoices->Rate_VAT }})</td>
